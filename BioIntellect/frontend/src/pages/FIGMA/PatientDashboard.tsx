...
import PatientLayout from '@/components/layout/FIGMA/PatientLayout';
import { 
  Calendar, 
  FileText, 
  Pill,
...
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, DialogTrigger } from '@/components/ui/FIGMA/dialog';
